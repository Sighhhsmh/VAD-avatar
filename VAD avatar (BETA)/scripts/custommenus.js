document.addEventListener("DOMContentLoaded", function () {
	...
	var canvas = document.getElementById("consolidated");
	...
	fmopt.innerText = ">> Edit Face Position";
	...
	pmopt.innerText = ">> Edit props Positions";
	...
	hideMouse.innerText = ">> Toggle Mouse Visibility";
	...
	function faceedit() {
		...
		headdiv.style.boxShadow = "0 0 20px 0 yellow";
	...
	// Event listener for right-click-----------------------------------------Body Context Menu
	canvas.addEventListener("contextmenu", function (event) {
		...
		contextMenu.appendChild(fmopt);
		fmopt.classList.remove('hide');
		contextMenu.appendChild(pmopt);
		pmopt.classList.remove("hide");
		contextMenu.appendChild(hideMouse);
		hideMouse.classList.remove("hide");
		contextMenu.appendChild(dopt);
		dopt.classList.remove("hide");
	});
