function initFaceMove() {
    // Your existing code that needs to run on window.onload
    ...
    if (isDragging) {
        ...
        newDivX = Math.max(-faceDiv.clientWidth/scale, Math.min(newDivX, maxX+(faceDiv.clientWidth/scale)));
