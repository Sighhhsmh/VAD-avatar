function virtualmouse() {
    ...
    mousepad.style.height = fh * 1.2 + "px";
// }
...
function updateMousePosition(event) {
    ...
    const mouseXNormalized = ((event.clientX - screenCenterX) / screenCenterX);
    const mouseYNormalized = ((event.clientY - screenCenterY) / screenCenterY);
